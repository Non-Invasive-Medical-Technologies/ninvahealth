    ...
    <div className="max-w-7xl mx-auto p-8 space-y-16">
      ...
      <section>
        ...
        <div className="grid grid-cols-3 gap-6">
          {/* Primary Card */}
          <Card className="bg-gradient-to-br from-white to-[#8FD5CA]/10 border border-[#E5E5E5] shadow-md">
            <CardHeader className="bg-[#26652C]/5 border-b border-[#26652C]/10">
              <CardTitle className="text-[#26652C] flex items-center gap-2">
          ...
          {/* Highlighted Card */}
          <Card className="bg-gradient-to-br from-[#8FD5CA]/20 to-[#4EC989]/10 border-2 border-[#8FD5CA] shadow-lg">
            <CardHeader className="border-b border-[#8FD5CA]">
              <CardTitle className="text-[#26652C] flex items-center gap-2">
          ...
          {/* Interactive Card */}
          <Card className="bg-gradient-to-br from-white to-[#BBE2BB]/20 border-2 border-transparent hover:border-[#26652C] transition-all duration-300 cursor-pointer hover:shadow-xl">
            <CardHeader>
